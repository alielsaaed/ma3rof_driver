...
class AddProfilePhotoScreen extends StatelessWidget {
  ...
  Future pickFile(AddPhotoController controller,
    ...
    try {
      ...
      String targetPath = '${tempDir.path}/temp_compressed_image.jpg';

      // Fix orientation and compress the image, storing it at a different path
      final XFile? fixedImage = await FlutterImageCompress.compressAndGetFile(
        imageFile.path, // Original image path
        targetPath, // New output path
        quality: 80, // Adjust quality as needed
        rotate: 0, // Automatically handles orientation
      );
      controller.image.value = fixedImage!.path;
      Get.back();
