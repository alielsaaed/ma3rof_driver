        ...
        builder: (controller) {
          return Scaffold(
            ...
            appBar: AppBar(
                ...
                elevation: 0,
                centerTitle: true,
                title: Text("Parcel Details".tr, style: const TextStyle(color: Colors.black)),
                leading: Padding(
                    ...
                    children: [
                      Expanded(
                        child: buildOtherDetails(
                          ...
                          value: "${controller.data.value.parcelDate} ${controller.data.value.parcelTime}",
                        ),
                      ),
                      Expanded(
                        child: buildOtherDetails(
                          title: "Drop Date".tr,
                          value: "${controller.data.value.receiveDate} ${controller.data.value.receiveTime}",
                        ),
                      )
                    ],
                  ),
              ...
              Row(
                ...
                children: [
                  Expanded(
                    child: buildOtherDetails(
                      title: "Distance".tr,
                      value: controller.data.value.distance.toString() + controller.data.value.distanceUnit.toString(),
                    ),
                  ),
