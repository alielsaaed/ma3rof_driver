...
class AllParcelScreen extends StatelessWidget {
            ...
            child: Scaffold(
              ...
              body: Padding(
                  ...
                  child: controller.parcelList.isEmpty
                      ? Constant.emptyView("You don't have any parcel confirmed.".tr)
                      : ListView.builder(
                          physics: const BouncingScrollPhysics(),
                          itemCount: controller.parcelList.length,
                          shrinkWrap: true,
                          itemBuilder: (context, index) {
                            return buildHistory(context, controller.parcelList[index], controller);
                          },
                        )),
            ),
          );
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: Text(data.userName.toString(), style: const TextStyle(color: Colors.black87, fontWeight: FontWeight.w600)),
                          ),
                        ),
                        Column(
                          ...
                          children: [
                            Padding(
                              ...
                              child: InkWell(
                                  onTap: () {
                                    Constant.makePhoneCall(data.userPhone.toString());
                                  },
                                  child: Image.asset(
                            ...
                            Padding(
                              ...
                              child: Text(data.parcelDate.toString(), style: const TextStyle(color: Colors.black26, fontWeight: FontWeight.w600)),
                            ),
                          ],
                        )
                      ],
                ...
                Row(
                  children: [
                    Text(
                      ...
                      style: TextStyle(fontSize: 16, color: isSender ? ConstantColors.primary : const Color(0xffd17e19)),
                    ),
                    Text(
  ...
  buildShowBottomSheet(BuildContext context, ParcelData data, ParcelServiceController controller) {
