                                  ...
                                  Expanded(
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(parcelData!.userName.toString(), style: const TextStyle(color: Colors.black87, fontWeight: FontWeight.w600)),
                                          StarRating(
                                              size: 18,
  ...
  getDirections({required double dLat, required double dLng}) async {
    ...
    if (parcelData!.status.toString() == "confirmed") {
      result = await polylinePoints.getRouteBetweenCoordinates(
        ...
        PointLatLng(double.parse(parcelData!.latSource.toString()), double.parse(parcelData!.lngSource.toString())),
