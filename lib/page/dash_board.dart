            ...
            appBar: AppBar(
              backgroundColor: controller.selectedDrawerIndex.value ==
                      (Constant.parcelActive == "yes" &&
                              controller
                                      .userModel.value.userData!.parcelDelivery
                                      .toString() ==
                                  "yes"
                          ? 5
                          : 3)
                  ...
                  : Container(
                      ...
                      child: Stack(
                        children: [
                          AnimatedAlign(
                            alignment: Alignment(
                                controller.isActive.value == true ? -1 : 1, 0),
                          ...
                          GestureDetector(
                            onTap: () async {
                              ...
                              } else if (controller.userModel.value.userData!
                                          .isVerified ==
                                      "no" ||
                              ...
                              child: Container(
                                ...
                                child: Text(
                                  ...
                                  style: GoogleFonts.poppins(
                                      color: controller.isActive.value == true
                                          ? Colors.white
                                          : Colors.black,
                            ...
                            child: Align(
                              ...
                              child: Container(
                                ...
                                child: Text(
                                  'Offline'.tr,
                                  style: GoogleFonts.poppins(
                                      color: controller.isActive.value == false
                                          ? Colors.white
                                          : Colors.black,
                                      fontWeight: FontWeight.w500,
                                      fontSize: 14),
        ...
        children: [
          controller.userModel == null
              ...
              : UserAccountsDrawerHeader(
                  ...
                  currentAccountPicture: ClipOval(
                    child: Container(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: controller.userModel.value.userData!.photoPath
                            .toString(),
                        fit: BoxFit.fill,
                  ...
                  accountName: Text(
                      '${controller.userModel.value.userData!.prenom.toString()} ${controller.userModel.value.userData!.nom.toString()}',
